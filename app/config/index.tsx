const BUTTON_STYLE = 'inline-block border-2 border-red-500 px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-neutral-50 transition duration-150 ease-in-out hover:text-neutral-100  focus:outline-none focus:ring-0 motion-reduce:transition-none hover:bg-red-500';
